...
class CourseInfoScreen100 extends StatefulWidget {
  @override
  _CourseInfoScreen100State createState() => _CourseInfoScreen100State();
}

class _CourseInfoScreen100State extends State<CourseInfoScreen100>
  ...
  Future launchURL(String url) async {
    const url =  "https://www.gamezop.com/g/41rGO1Gbqe?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
"https://static.gamezop.com/41rGO1Gbqe/wall.png",
                      ),
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
       "https://www.gamezop.com/g/41rGO1Gbqe?id=HGNsZjPh",    )),
                                        );
                                      },
                                      child: Container(
                                        height: 48,
