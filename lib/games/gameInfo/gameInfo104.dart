...
class CourseInfoScreen104 extends StatefulWidget {
  @override
  _CourseInfoScreen104State createState() => _CourseInfoScreen104State();
}

class _CourseInfoScreen104State extends State<CourseInfoScreen104>
  ...
  Future launchURL(String url) async {
    const url =  "https://www.gamezop.com/g/ByvOVQZkK?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
 "https://static.gamezop.com/ByvOVQZkK/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
    "https://www.gamezop.com/g/ByvOVQZkK?id=HGNsZjPh",    )),
                                        );
                                      },
                                      child: Container(
                                        height: 48,
