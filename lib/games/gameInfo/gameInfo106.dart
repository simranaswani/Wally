...
class CourseInfoScreen106 extends StatefulWidget {
  @override
  _CourseInfoScreen106State createState() => _CourseInfoScreen106State();
}

class _CourseInfoScreen106State extends State<CourseInfoScreen106>
  ...
  Future launchURL(String url) async {
    const url =   "https://www.gamezop.com/g/H16cNf0X6?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
 "https://static.gamezop.com/H16cNf0X6/wall.png",
                      ),
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
    "https://www.gamezop.com/g/H16cNf0X6?id=HGNsZjPh",  )),
                                        );
                                      },
                                      child: Container(
                                        height: 48,
