...
class CourseInfoScreen107 extends StatefulWidget {
  @override
  _CourseInfoScreen107State createState() => _CourseInfoScreen107State();
}

class _CourseInfoScreen107State extends State<CourseInfoScreen107>
  ...
  Future launchURL(String url) async {
    const url =  "https://www.gamezop.com/g/BJdZ-8iXULl?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
"https://static.gamezop.com/BJdZ-8iXULl/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
  "https://www.gamezop.com/g/BJdZ-8iXULl?id=HGNsZjPh", )),
                                        );
                                      },
                                      child: Container(
                                        height: 48,
