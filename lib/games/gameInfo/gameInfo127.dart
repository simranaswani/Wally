...
class CourseInfoScreen127 extends StatefulWidget {
  @override
  _CourseInfoScreen127State createState() => _CourseInfoScreen127State();
}

class _CourseInfoScreen127State extends State<CourseInfoScreen127>
  ...
  Future launchURL(String url) async {
    const url =   "https://www.gamezop.com/g/SJ3-ELT8p-x?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
 "https://static.gamezop.com/SJ3-ELT8p-x/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                           "https://www.gamezop.com/g/SJ3-ELT8p-x?id=HGNsZjPh",
)),
                                        );
                                      },
                                      child: Container(
