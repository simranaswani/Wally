...
class CourseInfoScreen144 extends StatefulWidget {
  @override
  _CourseInfoScreen144State createState() => _CourseInfoScreen144State();
}

class _CourseInfoScreen144State extends State<CourseInfoScreen144>
  ...
  Future launchURL(String url) async {
    const url =  "https://www.gamezop.com/g/SyTeia3fOeZ?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
"https://static.gamezop.com/SyTeia3fOeZ/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
              "https://www.gamezop.com/g/SyTeia3fOeZ?id=HGNsZjPh",
