...
class CourseInfoScreen145 extends StatefulWidget {
  @override
  _CourseInfoScreen145State createState() => _CourseInfoScreen145State();
}

class _CourseInfoScreen145State extends State<CourseInfoScreen145>
  ...
  Future launchURL(String url) async {
    const url =  "https://www.gamezop.com/g/rJWX-kadu?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
"https://static.gamezop.com/rJWX-kadu/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                             "https://www.gamezop.com/g/rJWX-kadu?id=HGNsZjPh",
