...
class CourseInfoScreen147 extends StatefulWidget {
  @override
  _CourseInfoScreen147State createState() => _CourseInfoScreen147State();
}

class _CourseInfoScreen147State extends State<CourseInfoScreen147>
  ...
  Future launchURL(String url) async {
    const url ="https://www.gamezop.com/g/r10-NLT86bx?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
 "https://static.gamezop.com/r10-NLT86bx/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
 "https://www.gamezop.com/g/r10-NLT86bx?id=HGNsZjPh",
)),
                                        );
                                      },
                                      child: Container(
