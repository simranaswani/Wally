...
class CourseInfoScreen149 extends StatefulWidget {
  @override
  _CourseInfoScreen149State createState() => _CourseInfoScreen149State();
}

class _CourseInfoScreen149State extends State<CourseInfoScreen149>
  ...
  Future launchURL(String url) async {
    const url =  "https://www.gamezop.com/g/HJXei0j?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
"https://static.gamezop.com/HJXei0j/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                        "https://www.gamezop.com/g/HJXei0j?id=HGNsZjPh",
