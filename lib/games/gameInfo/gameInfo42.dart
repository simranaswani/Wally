...
class CourseInfoScreen42 extends StatefulWidget {
  @override
  _CourseInfoScreen42State createState() => _CourseInfoScreen42State();
}

class _CourseInfoScreen42State extends State<CourseInfoScreen42>
  ...
  Future launchURL(String url) async {
    const url ="https://www.gamezop.com/g/SkGIa4X0l?id=HGNsZjPh" ;
              ...
              children: <Widget>[
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                       "https://static.gamezop.com/SkGIa4X0l/wall.png" //if(index==1){}
                        ,
                      ),
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                                       "https://www.gamezop.com/g/SkGIa4X0l?id=HGNsZjPh", 
                                                  )),
                                        );
                                      },
                                      child: Container(
