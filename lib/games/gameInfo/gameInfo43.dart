...
class CourseInfoScreen43 extends StatefulWidget {
  @override
  _CourseInfoScreen43State createState() => _CourseInfoScreen43State();
}

class _CourseInfoScreen43State extends State<CourseInfoScreen43>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/B1gBpzJwqJQ?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
                       "https://static.gamezop.com/B1gBpzJwqJQ/wall.png" ,
                      ),
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                                   "https://www.gamezop.com/g/B1gBpzJwqJQ?id=HGNsZjPh",
                                                  )),
                                        );
                                      },
                                      child: Container(
