...
class CourseInfoScreen44 extends StatefulWidget {
  @override
  _CourseInfoScreen44State createState() => _CourseInfoScreen44State();
}

class _CourseInfoScreen44State extends State<CourseInfoScreen44>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/4Jpbfuyzbcx?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
                    "https://www.gamezop.com/g/4Jpbfuyzbcx?id=HGNsZjPh",
                      ),
