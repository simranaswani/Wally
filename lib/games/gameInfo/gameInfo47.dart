...
class CourseInfoScreen47 extends StatefulWidget {
  @override
  _CourseInfoScreen47State createState() => _CourseInfoScreen47State();
}

class _CourseInfoScreen47State extends State<CourseInfoScreen47>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/r1zCFBZdV?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
                  "https://static.gamezop.com/r1zCFBZdV/wall.png",
                      ),
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    ...
                                                    "https://www.gamezop.com/g/r1zCFBZdV?id=HGNsZjPh",
                                                  )),
                                        );
                                      },
                                      child: Container(
