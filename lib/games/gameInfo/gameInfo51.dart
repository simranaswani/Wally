...
class CourseInfoScreen51 extends StatefulWidget {
  @override
  _CourseInfoScreen51State createState() => _CourseInfoScreen51State();
}

class _CourseInfoScreen51State extends State<CourseInfoScreen51>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/rylf9Id_M0?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
            "https://static.gamezop.com/rylf9Id_M0/wall.png",
                      ),
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                          "https://www.gamezop.com/g/rylf9Id_M0?id=HGNsZjPh",
                                                  )),
                                        );
                                      },
                                      child: Container(
