...
class CourseInfoScreen53 extends StatefulWidget {
  @override
  _CourseInfoScreen53State createState() => _CourseInfoScreen53State();
}

class _CourseInfoScreen53State extends State<CourseInfoScreen53>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/rJWwrYIB?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
            "https://static.gamezop.com/rJWwrYIB/wall.png",
                      ),
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                       "https://www.gamezop.com/g/rJWwrYIB?id=HGNsZjPh",
                                                  )),
                                        );
                                      },
                                      child: Container(
