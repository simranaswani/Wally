...
class CourseInfoScreen54 extends StatefulWidget {
  @override
  _CourseInfoScreen54State createState() => _CourseInfoScreen54State();
}

class _CourseInfoScreen54State extends State<CourseInfoScreen54>
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
               "https://www.gamezop.com/g/rkkfHP64Dt?id=HGNsZjPh",
                      ),
