...
class CourseInfoScreen55 extends StatefulWidget {
  @override
  _CourseInfoScreen55State createState() => _CourseInfoScreen55State();
}

class _CourseInfoScreen55State extends State<CourseInfoScreen55>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/rkYbNLTIT-x?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
             "https://static.gamezop.com/rkYbNLTIT-x/wall.png",
                      ),
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                             "https://www.gamezop.com/g/rkYbNLTIT-x?id=HGNsZjPh",
                                                  )),
                                        );
                                      },
                                      child: Container(
