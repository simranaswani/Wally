...
class CourseInfoScreen60 extends StatefulWidget {
  @override
  _CourseInfoScreen60State createState() => _CourseInfoScreen60State();
}

class _CourseInfoScreen60State extends State<CourseInfoScreen60>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/B1H5NfCXa?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
         "https://static.gamezop.com/B1H5NfCXa/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                               "https://www.gamezop.com/g/B1H5NfCXa?id=HGNsZjPh",        )),
                                        );
                                      },
                                      child: Container(
                                        height: 48,
