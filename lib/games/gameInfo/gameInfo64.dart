...
class CourseInfoScreen64 extends StatefulWidget {
  @override
  _CourseInfoScreen64State createState() => _CourseInfoScreen64State();
}

class _CourseInfoScreen64State extends State<CourseInfoScreen64>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/B1MfIa4QCg?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
         "https://static.gamezop.com/B1MfIa4QCg/wall.png",
                      ),
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                            "https://www.gamezop.com/g/B1MfIa4QCg?id=HGNsZjPh",       )),
                                        );
                                      },
                                      child: Container(
                                        height: 48,
