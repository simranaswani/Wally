...
class CourseInfoScreen66 extends StatefulWidget {
  @override
  _CourseInfoScreen66State createState() => _CourseInfoScreen66State();
}

class _CourseInfoScreen66State extends State<CourseInfoScreen66>
  ...
  Future launchURL(String url) async {
    const url ="https://www.gamezop.com/g/rJJMVIa8p-x?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
      "https://static.gamezop.com/rJJMVIa8p-x/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                          "https://www.gamezop.com/g/rJJMVIa8p-x?id=HGNsZjPh",   )),
                                        );
                                      },
                                      child: Container(
                                        height: 48,
