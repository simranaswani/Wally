...
class CourseInfoScreen67 extends StatefulWidget {
  @override
  _CourseInfoScreen67State createState() => _CourseInfoScreen67State();
}

class _CourseInfoScreen67State extends State<CourseInfoScreen67>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/HyKCFB-dV?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
     "https://static.gamezop.com/HyKCFB-dV/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                      "https://www.gamezop.com/g/HyKCFB-dV?id=HGNsZjPh",    )),
                                        );
                                      },
                                      child: Container(
                                        height: 48,
