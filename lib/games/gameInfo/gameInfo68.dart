...
class CourseInfoScreen68 extends StatefulWidget {
  @override
  _CourseInfoScreen68State createState() => _CourseInfoScreen68State();
}

class _CourseInfoScreen68State extends State<CourseInfoScreen68>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/SJJl94z0m6?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
      "https://static.gamezop.com/SJJl94z0m6/wall.png",
                      ),
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                         "https://www.gamezop.com/g/SJJl94z0m6?id=HGNsZjPh",     )),
                                        );
                                      },
                                      child: Container(
                                        height: 48,
