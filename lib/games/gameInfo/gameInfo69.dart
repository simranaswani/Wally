...
class CourseInfoScreen69 extends StatefulWidget {
  @override
  _CourseInfoScreen69State createState() => _CourseInfoScreen69State();
}

class _CourseInfoScreen69State extends State<CourseInfoScreen69>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/rJsl0KSbuN?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
     "https://static.gamezop.com/rJsl0KSbuN/wall.png",
                      ),
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                        "https://www.gamezop.com/g/rJsl0KSbuN?id=HGNsZjPh",
           )),
                                        );
                                      },
                                      child: Container(
