...
class CourseInfoScreen70 extends StatefulWidget {
  @override
  _CourseInfoScreen70State createState() => _CourseInfoScreen70State();
}

class _CourseInfoScreen70State extends State<CourseInfoScreen70>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/r1HAtSWO4?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
    "https://static.gamezop.com/r1HAtSWO4/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                         "https://www.gamezop.com/g/r1HAtSWO4?id=HGNsZjPh",   )),
                                        );
                                      },
                                      child: Container(
                                        height: 48,
