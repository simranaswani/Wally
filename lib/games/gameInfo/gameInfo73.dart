...
class CourseInfoScreen73 extends StatefulWidget {
  @override
  _CourseInfoScreen73State createState() => _CourseInfoScreen73State();
}

class _CourseInfoScreen73State extends State<CourseInfoScreen73>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/41DxMOkGZ5g?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
  "https://static.gamezop.com/41DxMOkGZ5g/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                   "https://www.gamezop.com/g/41DxMOkGZ5g?id=HGNsZjPh",    )),
                                        );
                                      },
                                      child: Container(
                                        height: 48,
