...
class CourseInfoScreen74 extends StatefulWidget {
  @override
  _CourseInfoScreen74State createState() => _CourseInfoScreen74State();
}

class _CourseInfoScreen74State extends State<CourseInfoScreen74>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/rkHuVQ-1K?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
   "https://static.gamezop.com/rkHuVQ-1K/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                                  "https://www.gamezop.com/g/rkHuVQ-1K?id=HGNsZjPh",
  )),
                                        );
                                      },
                                      child: Container(
