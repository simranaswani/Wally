...
class CourseInfoScreen82 extends StatefulWidget {
  @override
  _CourseInfoScreen82State createState() => _CourseInfoScreen82State();
}

class _CourseInfoScreen82State extends State<CourseInfoScreen82>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/r1z-eQ8nq?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
 "https://static.gamezop.com/r1z-eQ8nq/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
                     "https://www.gamezop.com/g/r1z-eQ8nq?id=HGNsZjPh",  )),
                                        );
                                      },
                                      child: Container(
                                        height: 48,
