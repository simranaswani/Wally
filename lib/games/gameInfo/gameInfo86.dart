...
class CourseInfoScreen86 extends StatefulWidget {
  @override
  _CourseInfoScreen86State createState() => _CourseInfoScreen86State();
}

class _CourseInfoScreen86State extends State<CourseInfoScreen86>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/B1MXhUFQke?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
 "https://static.gamezop.com/B1MXhUFQke/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
          "https://www.gamezop.com/g/B1MXhUFQke?id=HGNsZjPh",     )),
                                        );
                                      },
                                      child: Container(
                                        height: 48,
