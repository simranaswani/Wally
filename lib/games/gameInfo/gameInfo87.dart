...
class CourseInfoScreen87 extends StatefulWidget {
  @override
  _CourseInfoScreen87State createState() => _CourseInfoScreen87State();
}

class _CourseInfoScreen87State extends State<CourseInfoScreen87>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/VJQzukG-qx?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
"https://static.gamezop.com/VJQzukG-qx/wall.png",
                      ),
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
            "https://www.gamezop.com/g/VJQzukG-qx?id=HGNsZjPh",
      )),
                                        );
                                      },
                                      child: Container(
