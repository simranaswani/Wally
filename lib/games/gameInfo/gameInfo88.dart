...
class CourseInfoScreen88 extends StatefulWidget {
  @override
  _CourseInfoScreen88State createState() => _CourseInfoScreen88State();
}

class _CourseInfoScreen88State extends State<CourseInfoScreen88>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/S1gGrw64wY?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
"https://static.gamezop.com/S1gGrw64wY/wall.png",
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
             "https://www.gamezop.com/g/S1gGrw64wY?id=HGNsZjPh",  )),
                                        );
                                      },
                                      child: Container(
                                        height: 48,
