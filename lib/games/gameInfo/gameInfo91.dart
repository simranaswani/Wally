...
class CourseInfoScreen91 extends StatefulWidget {
  @override
  _CourseInfoScreen91State createState() => _CourseInfoScreen91State();
}

class _CourseInfoScreen91State extends State<CourseInfoScreen91>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/BkzmafyPqJm?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
"https://static.gamezop.com/BkzmafyPqJm/wall.png",
                      ),
                          ...
                          Expanded(
                            child: AnimatedOpacity(
                              ...
                              child: Padding(
                                ...
                                child: Text(
"You've got 3 wickets and an audience to impress! Go at it! Make as many runs as you can. Be careful of the bombs and eggs?!",                                  textAlign: TextAlign.justify,
                                  style: TextStyle(
                                    fontFamily: "Netflix",
                                    fontWeight: FontWeight.w600,
                                    fontSize: 23,
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
      "https://www.gamezop.com/g/BkzmafyPqJm?id=HGNsZjPh",
    )),
                                        );
                                      },
                                      child: Container(
