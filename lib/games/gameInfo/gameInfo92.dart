...
class CourseInfoScreen92 extends StatefulWidget {
  @override
  _CourseInfoScreen92State createState() => _CourseInfoScreen92State();
}

class _CourseInfoScreen92State extends State<CourseInfoScreen92>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/ryRWrDaNPF?id=HGNsZjPh";
              ...
              children: <Widget>[
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
 "https://static.gamezop.com/ryRWrDaNPF/wall.png",
                      ),
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
          "https://www.gamezop.com/g/ryRWrDaNPF?id=HGNsZjPh",
  )),
                                        );
                                      },
                                      child: Container(
