...
class CourseInfoScreen93 extends StatefulWidget {
  @override
  _CourseInfoScreen93State createState() => _CourseInfoScreen93State();
}

class _CourseInfoScreen93State extends State<CourseInfoScreen93>
  ...
  Future launchURL(String url) async {
    const url =  "https://www.gamezop.com/g/Sy64_WbU?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
 "https://static.gamezop.com/Sy64_WbU/wall.png",
                      ),
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
         "https://www.gamezop.com/g/Sy64_WbU?id=HGNsZjPh",
    )),
                                        );
                                      },
                                      child: Container(
