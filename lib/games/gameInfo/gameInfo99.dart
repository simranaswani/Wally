...
class CourseInfoScreen99 extends StatefulWidget {
  @override
  _CourseInfoScreen99State createState() => _CourseInfoScreen99State();
}

class _CourseInfoScreen99State extends State<CourseInfoScreen99>
  ...
  Future launchURL(String url) async {
    const url = "https://www.gamezop.com/g/rJsWV8aIa-l?id=HGNsZjPh";
                ...
                Container(
                  child: AspectRatio(
                    ...
                    child: Image(
                      image: NetworkImage(
                    //if(index==1){}
                 "https://static.gamezop.com/rJsWV8aIa-l/wall.png",     ),
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  WebviewScaffold(
                                                    url:
   "https://www.gamezop.com/g/rJsWV8aIa-l?id=HGNsZjPh",
  )),
                                        );
                                      },
                                      child: Container(
