...
class TabIconData {
  ...
  static List<TabIconData> tabIconsList = [
    TabIconData(
      ...
      selctedImagePath: 'assets/app/tab_1s.png',
      index: 0,
      isSelected: true,
    ...
    TabIconData(
      ...
      selctedImagePath: 'assets/app/tab_2s.png',
      index: 1,
      isSelected: false,
      animationController: null,
    ),
    TabIconData(
      ...
      selctedImagePath: 'assets/app/tab_3s.png',
      index: 2,
      isSelected: false,
      animationController: null,
    ),
    TabIconData(
      ...
      selctedImagePath: 'assets/app/tab_4s.png',
      index: 3,
      isSelected: false,
      animationController: null,
    ),
