...
class OfferwallView2 extends StatelessWidget {
  final AnimationController animationController;
  final Animation animation;
  final Function firebaseAdmob;

  const OfferwallView2({Key key, this.animationController, this.animation, this.firebaseAdmob})
      : super(key: key);
